<?php
/**
 * Plugin Name: Noobertx 8 Elementor Modules
 * Description: 8 Elementor Modules  : Advance Backgrounds, Animated Content, Interactive Banner, Animated Text, Highlight Box, Cube Box, Flipbox , Info Banner
 */
